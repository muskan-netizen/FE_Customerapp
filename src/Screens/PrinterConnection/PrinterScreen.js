...
export const printReciept = async (data) => {
  ...
  BluetoothManager.checkBluetoothEnabled().then(async (enabled) => {
    ...
    console.log('check connected device >>> ', isConnected)
    if (enabled && isConnected) {
      try {
        ...
        // await BluetoothEscposPrinter.printText("Member card payment: 0.00\r\n", {});
        // await BluetoothEscposPrinter.printText("Points deduction: 0.00\r\n", {});
        // await BluetoothEscposPrinter.printText("Amount paid: 64000.00\r\n", {});
