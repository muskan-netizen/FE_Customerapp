            ...
            <TouchableOpacity
                ...
                style={{
                    ...
                    backgroundColor: isDarkMode
                        ? selectedCarOption?.id == item?.id ? colors.whiteOpacity15 : colors.textGrey
                        :
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                    ...
                    <View style={{
                        ...
                        <Text
                            ...
                            style={{
                                color: isDarkMode
                                    ? selectedCarOption?.id == item?.id ? colors.white : colors.whiteOpacity50
                                    : selectedCarOption?.id == item?.id ? colors.black : colors.blackC,
                        ...
                        <Text style={{
                            color: isDarkMode
                                ? selectedCarOption?.id == item?.id ? colors.white : colors.whiteOpacity50
                                : selectedCarOption?.id == item?.id ? colors.black : colors.blackOpacity66,
                            fontFamily: fontFamily.regular,
                            fontSize: textScale(10),
                            textAlign: 'left',
                        }}>Affordable {item?.translation[0]?.title} ride </Text>
                    </View>
                </View>
                <Text
                    numberOfLines={1}
