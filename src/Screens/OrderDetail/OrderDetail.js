  ...
  const _getOrderDetailScreen = () => {
    ...
    actions
      ...
      .then((res) => {
        ...
        if (!!res?.data && !!res?.data?.vendors[0] && res?.data?.vendors[0].lalamove_tracking_url && res?.data?.vendors[0].shipping_delivery_type == 'L') {
  ...
  const getHeader = () => {
    ...
    return (
      <View>
        ...
        {!!driverStatus && !!driverStatus?.agent_location?.lat && !lalaMoveUrl ? (
