                ...
                if (res && res.data) {
                    if (res.data.vendor_details.vendor_tables) {
                        res.data.vendor_details.vendor_tables.forEach(
                            ...
                            (tableData[indx] = {
                                id: item.id,
                                label: `Category: ${item.category.title ? item.category.title : ''
                                    } | Table: ${item.table_number ? item.table_number : 0
                                    } | Seat Capacity: ${item.seating_number ? item.seating_number : 0
                                    }`,
                                value: `Category: ${item.category.title ? item.category.title : ''
                                    } | Table: ${item.table_number ? item.table_number : 0
                                    } | Seat Capacity: ${item.seating_number ? item.seating_number : 0
                                    }`,
            ...
            <View
                ...
                {item?.vendor_products.length
                    ? item?.vendor_products.map((i, inx) => {
                        return (
                            <Swipeable ref={swipeRef} friction={1} renderRightActions={swipeBtns}>
                                <View style={{
                                    backgroundColor: isDarkMode ? MyDarkTheme.colors.background : '#fff',
                                    marginBottom: moderateScaleVertical(12),
                                            ...
                                            <View
                                                ...
                                                <View style={{ flex: 0.6 }}>
                                                    ...
                                                    <Text style={{
                                                        ...styles.priceItemLabel2,
                                                        fontSize: textScale(12),
                                                        color: isDarkMode ? MyDarkTheme.colors.text : '#B3B3B3',
                                                ...
                                                <View style={{ flex: 0.3, paddingRight: moderateScale(8) }}>
