      ...
      .then((res) => {
        ...
        if (res && res.data) {
          ...
          updateState({
            ...
            isLoadingB: false,
            isRefreshing: false,
            selectedTipvalue: res?.data?.total_payable_amount == 0 ? 'custom' : null,
          });
      ...
      actions
        .openPaymentWebUrl(
          `/${selectedMethod}?tip=${selectedTipAmount && selectedTipAmount != ''
            ? Number(selectedTipAmount)
            : 0
          }&amount=${cartData?.total_payable_amount == 0 ? selectedTipAmount : cartData?.total_payable_amount}&auth_token=${userData?.auth_token
          ...
          cartData?.tip.length && (
            <View
              ...
              <ScrollView
                ...
                {cartData?.total_payable_amount !== 0 && (<TouchableOpacity
                  style={[
                    styles.tipArrayStyle2,
                    {
                      backgroundColor:
