...
function Cart({ navigation, route }) {
  ...
  console.log('closed_store_order_scheduled', vendorAddressId);
  ...
  console.log(vendorAddress, "vendorAddressvendorAddressvendorAddress");
  const getHeader = () => {
    return (
      <TouchableOpacity
        disabled={dineInType == 'delivery' ? false : true}
