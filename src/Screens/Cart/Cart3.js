            ...
            {appIds?.meatEasy == DeviceInfo.getBundleId() ? (
              ...
              <View
                ...
                {!!item?.delivery_types && item?.delivery_types.length == 1 ? (
                  <Text>{`${item?.delivery_types[0]?.courier_name} ${currencies?.primary_currency?.symbol
                    }${currencyNumberFormatter(
          ...
          <Text
            style={
              isDarkMode
                ...
                Number(cartData?.total_container_charges ? cartData?.total_container_charges : 0),
                appData?.profile?.preferences?.digit_after_decimal,
              )}`}</Text>
        </View>
              ...
              {cartData?.specific_taxes.map((val, index) => {
                ...
                return (
                  ...
                  <View  >
                    ...
                    {val?.value > 0 && <View style={{ ...styles.bottomTabLableValue, marginVertical:1 }}><Text
                      style={{
                        ...styles.priceItemLabel,
                        color: isDarkMode
                          ? MyDarkTheme.colors.text
