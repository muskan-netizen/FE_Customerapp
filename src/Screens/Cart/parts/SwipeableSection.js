 ...
 * @param {item ,deleteItem,addDeleteCartItems,tokenConverterPlusCurrencyNumberFormater,getHourAndMinutes,swipeRef,swipeKey,swipeBtns,isDarkMode,colors,styles,FastImage,imagePath,fontFamily,appIds,btnLoadrId,btnLoader,digit_after_decimal,additional_preferences,MyDarkTheme,currencies,cartData,scheduleType,openDeleteView,openPickerForPrescription} props 
 * @returns 
 */

function SwipeableSection(props) {

    const { item, deleteItem, addDeleteCartItems, tokenConverterPlusCurrencyNumberFormater, getHourAndMinutes, swipeRef, swipeKey, swipeBtns, isDarkMode, colors, styles, FastImage, imagePath, fontFamily, appIds, btnLoadrId, btnLoader, digit_after_decimal, additional_preferences, MyDarkTheme, currencies, cartData, strings, scheduleType, openDeleteView, openPickerForPrescription } = props;
    return (
        <>
