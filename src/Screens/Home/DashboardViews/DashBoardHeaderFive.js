        ...
        {tabs.map((item, indx) => {
          return (
            <TouchableOpacity
              ...
              style={{
                width: width / 3 - 8,
                borderBottomColor: item.isActive && isDarkMode
                ? MyDarkTheme.colors.white
                : item.isActive && !isDarkMode ? themeColors.primary_color
                  : isDarkMode ? colors.blackOpacity0 : colors.greyColor1,
                borderBottomWidth: 2,
              ...
              <Image
                ...
                style={{
                  ...
                  tintColor: item.isActive && isDarkMode
                    ? MyDarkTheme.colors.white
                    : item.isActive && !isDarkMode ? themeColors.primary_color
                      : colors.greyLight,
                  // ? themeColors.primary_color
              ...
              <Text
                style={{
                  ...
                  color: item.isActive && isDarkMode
                    ? MyDarkTheme.colors.white
                    : item.isActive && !isDarkMode ? themeColors.primary_color
                      : colors.greyLight,
