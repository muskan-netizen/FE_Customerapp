...
import ProductsCompTwo from '../../../Components/ProductsCompTwo';
...
export default function DashBoardNine({
  handleRefresh = () => {},
  bannerPress = () => {},
  isLoading = true,
  isRefreshing = false,
      ...
      <ScrollView
        ...
        <Animatable.View animation={'fadeInUp'} delay={200}>
          {!!isGetEstimation ? (
            ...
            <>
              {listHeader(strings.SELECT_CATEGORY)}
              {categoriesBanners()}
            </>
          )}
            ...
            <View style={{}}>
              {appMainData &&
                ...
                !!appMainData?.brands.length && (
                  <>
                    <View>{listHeader(`Promoted Brands`)}</View>
                    <FlatList
                      showsHorizontalScrollIndicator={false}
                      horizontal
                ...
                !!appMainData?.featured_products.length && (
                  <>
                    {appIds.orderchekout == DeviceInfo.getBundleId() ? (
                      ...
                      <View>{listHeader(`In The Spotlight`)}</View>
                    )}
        ...
        <View
          style={{
            height: Platform.OS == 'ios' ? moderateScale(5) : moderateScale(5),
          }}
        />
      </ScrollView>
