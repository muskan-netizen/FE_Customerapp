...
export default function Home({ route, navigation }) {
  ...
  const _getLocationFromParams = () => {
    ...
    if (paramData?.details && paramData?.details?.formatted_address != location?.address) {
