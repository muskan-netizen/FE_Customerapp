...
Amount`,
  ...
  CONNECTING_YOU_TO_NEARBY_DELIVERY_AGENT: 'CONNECTING YOU TO NEARBY DELIVERY AGENT',
  ...
  SORRY_MSG: "Sorry, we currently don\'t deliver here but we are expanding quickly. Kindly check back soon!",
  ...
  NEW_RIDER:'New Rider',
  THIS_CONTACT_WILL_NOT_SAVE_IN_ADDRESS_BOOK:"This Contact won't be saved in your device's address book.",
  CHNAGING_THE_NAME_WILL_NOT_AFFECT_IN_YOUR_DEVICE_CONTACT:" Changing the name here won't affect how it appears in your device's contacts",
  DRIVER_WILL_SEE_NAME:'Drivers will see this name. Do you want to make any changes?',
 ADD_RIDER :'Add Rider',
