...
const NotificationModal = () => {
    ...
    const isVendorNotification = useSelector((state) => state?.pendingNotifications?.isVendorNotification);
    ...
    const renderContent = () => (
        <View style={{ height: height / 1.2, alignItems: 'center' }}>
            <FlatList
                ...
                ItemSeparatorComponent={() => <View style={{ marginBottom: moderateScaleVertical(12) }} />}
            />
        </View>
